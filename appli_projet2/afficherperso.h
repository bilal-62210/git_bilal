...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btn_exit->Click += gcnew System::EventHandler(this, &Form15::btn_exit_Click);
			// 
			// btn_valider
			// 
			...
			this->btn_valider->Click += gcnew System::EventHandler(this, &Form15::btn_valider_Click);
			// 
			// personnel_view
			// 
			this->personnel_view->ColumnHeadersHeightSizeMode = System::Windows::Forms::DataGridViewColumnHeadersHeightSizeMode::AutoSize;
			this->personnel_view->Location = System::Drawing::Point(119, 192);
			this->personnel_view->Name = L"personnel_view";
			this->personnel_view->RowHeadersWidth = 51;
			this->personnel_view->RowTemplate->Height = 24;
			this->personnel_view->Size = System::Drawing::Size(900, 459);
			this->personnel_view->TabIndex = 37;
			this->personnel_view->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Form15::personnel_view_CellContentClick);
			// 
			// checkBox_spe
			// 
			...
			this->checkBox_spe->Text = L"personnel_specifique";
			this->checkBox_spe->UseVisualStyleBackColor = true;
			this->checkBox_spe->CheckedChanged += gcnew System::EventHandler(this, &Form15::checkBox_spe_CheckedChanged);
			// 
			// checkBox_complet
			// 
			...
			this->checkBox_complet->Text = L"table_personnel_complet";
			this->checkBox_complet->UseVisualStyleBackColor = true;
			this->checkBox_complet->CheckedChanged += gcnew System::EventHandler(this, &Form15::checkBox_complet_CheckedChanged);
			// 
			// textBox_spe
			// 
			...
			this->textBox_spe->TextChanged += gcnew System::EventHandler(this, &Form15::textBox_spe_TextChanged);
			// 
			// groupBox_identite
			// 
			...
			this->groupBox_identite->Enter += gcnew System::EventHandler(this, &Form15::groupBox_identite_Enter);
			// 
			// textBox_prenom
			// 
			...
			this->textBox_prenom->TextChanged += gcnew System::EventHandler(this, &Form15::textBox_prenom_TextChanged);
			// 
			// label_prenom
			// 
			...
			this->label_prenom->Click += gcnew System::EventHandler(this, &Form15::label_prenom_Click);
			// 
			// label_nom
			// 
			...
			this->label_nom->Click += gcnew System::EventHandler(this, &Form15::label_nom_Click);
			// 
			// Form15
			// 
...
#pragma endregion
	...
	private: System::Void btn_valider_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (this->checkBox_spe->Checked == true)
		{
			...
			appli->Open();
			String^ q = "select* from tab_personnel where tab_personnel.nom_personnel='" + textBox_spe->Text->ToString() + "' AND prenom_personnel = '" + textBox_prenom->Text->ToString() + "' ";
			SqlDataAdapter^ sda = gcnew SqlDataAdapter(q, appli);
			DataTable^ dt = gcnew DataTable();
			sda->Fill(dt);
			personnel_view->DataSource = dt;
		}
		if (this->checkBox_complet->Checked == true)
		{
			SqlConnection^ appli = gcnew SqlConnection(ip);
			appli->Open();
			String^ a = "select* from tab_personnel ";
			SqlDataAdapter^ sda1 = gcnew SqlDataAdapter(a, appli);
			DataTable^ dt1 = gcnew DataTable();
			sda1->Fill(dt1);
			personnel_view->DataSource = dt1;
		}
	}
